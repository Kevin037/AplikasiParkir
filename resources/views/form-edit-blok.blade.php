          ...
          <div class="col-12">
            <div class="card">
                <div class="modal-content">
                    ...
                    <form action="/update-blok{{ $data->id }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    @csrf
                                                    <div class="position-relative form-group">
                                                      <label>Nama</label>
                                                      <input name="nama_blok" type="text" value="{{ $data->nama }}" class="form-control"  required>
